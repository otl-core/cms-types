...
export interface HeaderNavigationItem {
  id: string;
  type: "logo" | "link" | "button" | "dropdown" | "markdown" | "image";
  label?: string | LocalizedString | null;
  visibility?: "responsive" | "navbar-only" | "mobile-only" | "both";
...
export interface HeaderNavigationItemMarkdownConfig {
  content: string | LocalizedString;
  color?: ColorReference;
}

export interface HeaderNavigationItemImageConfig {
  src: string;
  alt?: string;
  width?: string;
  height?: string;
...
export interface HeaderDropdownGroupConfig {
...
/** @deprecated Use HeaderDropdownGroupConfig instead */
export type HeaderDropdownSectionConfig = HeaderDropdownGroupConfig;
